...
import { DoughnutCahart, LineChart } from './Chart';
    ...
    >
      <Box boxSizing="border-box" py="16" px={['4', '0']}>
        ...
        >
          ...
          <Databox title="Users" qty={50} qtyPercentage={85} profit={true} />
          <Databox
            title="Subscription"
            qty={15}
            qtyPercentage={20}
        ...
        <Grid templateColumns={['1fr', '2fr 1fr']}>
          <Box p="4">
            ...
            <Box>
              ...
              <Bar profit={true} title="Users" value={85} />
